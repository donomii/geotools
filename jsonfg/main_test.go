...
func TestJSONFGRejectsInvalidTemporalAndConformanceData(t *testing.T) {
	cases := []string{
		...
		`{"type":"FeatureCollection","conformsTo":["http://www.opengis.net/spec/json-fg-1/1.0/conf/core"],"features":[{"type":"Feature","geometry":{"type":"Point","coordinates":[1,2]},"time":{"date":"2026-07-25","unknown":true},"properties":{}}]}`,
		`{"type":"FeatureCollection","conformsTo":["http://www.opengis.net/spec/json-fg-1/1.0/conf/core"],"features":[{"type":"Feature","geometry":{"type":"Point","coordinates":[1,2]},"time":{"date":null},"properties":{}}]}`,
		`{"type":"FeatureCollection","conformsTo":["http://www.opengis.net/spec/json-fg-1/1.0/conf/core"],"features":[{"type":"Feature","geometry":{"type":"Point","coordinates":[1,2]},"time":{"interval":null},"properties":{}}]}`,
